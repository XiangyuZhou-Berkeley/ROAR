    ...
    def start_game_loop(self, auto_pilot=False):
        ...
        try:
            ...
            while should_continue:
                ...
                #print("x" + str(self.veh_state_streamer.velocity.x))
                #print("y" + str(self.veh_state_streamer.velocity.y))
                #print("z" + str(self.veh_state_streamer.velocity.z))
            ...
            vehicle = self.ios_bridge.convert_vehicle_from_source_to_agent(
                {
                    ...
                    "throttle" : self.veh_state_streamer.throttle
                }
            )
